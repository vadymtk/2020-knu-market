...
import pandas as pd
#функции для подсчета еластичности
...
def elasticity_ols_models(data, models, give_info=False, correct_length_of_sales=6):#эластичность по моделям (всем) у models
